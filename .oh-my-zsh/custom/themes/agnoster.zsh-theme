...
seasonal_colours () {
  ...
  case $date in
    # spring
    *Mar*|*Apr*|*May*)
      SEASONAL_COLOUR_1=cyan
      SEASONAL_COLOUR_2=green
      SEASONAL_COLOUR_3=yellow
      ;;
    # summer
    *Jun*|*Jul*|*Aug*)
      SEASONAL_COLOUR_1=green
      SEASONAL_COLOUR_2=yellow
      SEASONAL_COLOUR_3=red
      ;;
    # fall
    *Sep*|*Oct*|*Nov*)
      SEASONAL_COLOUR_1=yellow
      SEASONAL_COLOUR_2=red
      SEASONAL_COLOUR_3=magenta
      ;;
    # winter
    *Dec*|*Jan*|*Feb*)
      SEASONAL_COLOUR_1=magenta
      SEASONAL_COLOUR_2=cyan
      SEASONAL_COLOUR_3=green
      ;;
    *)
      ;;
  esac
